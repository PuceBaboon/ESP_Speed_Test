/*
 *   $Id: Speed_Test_Static.txt,v 1.2 2017/05/06 00:19:22 gaijin Exp $
 *
 ...
 *
 * THIS IS THE STATIC VERSION - USE THE platformio.ini FILE
 * "board_f_cpu = 160000000L" SETTING TO CHANGE THE CLOCK
 * SPEED BETWEEN COMPILES (COMMENT IT OUT TO GO BACK TO 80MHZ).
 */
